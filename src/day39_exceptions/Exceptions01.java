...
public class Exceptions01 {
	...
	public static void main(String[] args) {
		...
		//Java "Ya dosyayi bulamazsam" der ve cozum uretmemizi ister
		...
		try {
			FileInputStream fis=new FileInputStream("C:\\Users\\admin\\eclipse-workspace\\winter2021turkish\\src1\\day39_exceptions\\File");
