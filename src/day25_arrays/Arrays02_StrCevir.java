...
public class Arrays02_StrCevir {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.binarySearch(arr, 28));//olsaydi nerede oldugunu index olarak degil
		                                                 //eleman yeri olarak eksili halini verir.Buda olmadigini gosterir
		
		//binary searc sonuc olarak aradigimiz eleman varsa indexini verir
		//aradiginiz eleman yoksa - isareti ile olsaydi kacinci eleman olacagini dondurur
